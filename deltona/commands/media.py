...
@click.option(
    '--never-skip', help="Passed to cdparanoia's --never-skip=... option.", type=int, default=5
)
@click.option('-d', '--debug', is_flag=True, help='Enable debug output.')
@click.option(
    '-o', '--output-dir', help='Parent directory for album_dir. Defaults to current directory.'
)
